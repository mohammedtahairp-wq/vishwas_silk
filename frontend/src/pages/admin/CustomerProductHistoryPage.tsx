    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex items-end gap-3">
          <Filter label="From">
            <input type="date" value={from} max={to} onChange={(e) => updateDate("from", e.target.value)} className="filter-input" />
          </Filter>
          <Filter label="To">
            <input type="date" value={to} min={from} onChange={(e) => updateDate("to", e.target.value)} className="filter-input" />
          </Filter>
        </div>
      </div>
